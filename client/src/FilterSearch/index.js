    ...
    return (
      <div className="container">
        ...
        <div className='card-list filtered-names'>{filteredCards.map((card)=>{
          return(
      <Link to="/view/card"><img id="player-img" className="card-img" id={card.id} src={card.img} style={{ paddingRight: '25px'}}/><p className="player-name"><strong>{card.name}</strong></p></Link>
          )
